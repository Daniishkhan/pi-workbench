...
Use `shipyard_findings` for evidence-backed defects. During an independent/first-wave task, do not list or read peer findings before completing your own discovery; add directly. After that barrier, search before adding. Do not turn broad architectural preferences into findings; name the concrete broken interaction, trigger, and smallest compatible correction.
